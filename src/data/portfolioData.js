export const personalInfo = {
  ...
  hobbies: ['Martial Arts', 'Dungeons & Dragons', 'Musical Instruments', 'Game Development'],
...
export const resumeModes = {
  'AI/ML': {
    ...
    flavor: 'Trains on data, deploys insight, and rolls Arcana for RAG pipelines.',
    stats: [
    ...
    skills: [
      'Python', 'LlamaIndex', 'Mistral', 'Phi-2',
      'Tesseract OCR', 'PaddleOCR', 'SQL', 'Git/GitHub',
    ],
    background:
  ...
  'Fullstack': {
    ...
    flavor: 'Casts React spells from the frontend, communes with databases below.',
    stats: [
    ...
    skills: [
      ...
      'Supabase', 'SQLite', 'Python', 'Git/GitHub',
    ],
    background:
  ...
  'Gamedev': {
    ...
    skills: [
      'C#', 'Unity', 'Python', 'JavaScript',
      'C++', 'Git/GitHub', 'Game Design', 'QA Playtesting',
    ],
    background:
...
export const projects = [
  {
    ...
    status: 'In Progress',
    description: 'AI pipelines for pharmaceutical vendor file processing using OCR and RAG.',
    bullets: [
    ...
    tech: ['Python', 'Tesseract', 'PaddleOCR', 'LlamaIndex', 'Mistral', 'Phi-2'],
    url: null,
    modes: ['AI/ML'],
  },
  {
    ...
    status: 'Shipped',
    description: 'Responsive React event platform for De Anza Expo with authenticated organizer dashboard.',
    bullets: [
  ...
  },
  {
    ...
    status: 'Shipped',
    description: 'Modernized marketing website and enrollment flow for a Muay Thai gym.',
    bullets: [
  ...
  },
  {
    ...
    dates: '2025 – Present',
    status: 'In Progress',
    description: 'Gamified mobile study app with XP, streaks, and daily quests.',
    bullets: [
  ...
  },
  {
    ...
    dates: 'Jan 2025 – Present',
    status: 'Ongoing',
    description: 'Organized and ran the Game Dev Club\'s first Game Jam as Club President.',
    bullets: [
